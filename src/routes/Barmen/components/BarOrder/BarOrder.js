...
export const BarOrder = ({ order, drink, completeOrder }) => {
  ...
  return (
    <div className='order-card'>
      ...
      {!isCanceled && <div className='order-card__actions' onClick={() => isNew && completeOrder(order.order_id)}>
          <svg
